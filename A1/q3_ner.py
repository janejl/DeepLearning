...
class FFC(tf.keras.Model):
    ...
    def __init__(self, ffc_units, num_labels):
        ...
        ### YOUR CODE HERE (2 lines)
        self.W1 = tf.keras.layers.Dense(ffc_units)
        self.W2 = tf.keras.layers.Dense(num_labels)
        ### END YOUR CODE
...
def train(n_epochs=10, batch_size=64, learning_rate=0.0001):
...
if __name__ == '__main__':
    ...
    train(n_epochs=10, batch_size=128, learning_rate=0.001)
    predict()
